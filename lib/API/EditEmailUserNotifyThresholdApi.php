...
class EditEmailUserNotifyThresholdApi extends ApiValidatorAbstract implements ApiInterface
{
    use ResponseTraits;
    ...
    function run(): void
    {
        ...
        $notify->threshold = $_REQUEST['threshold'] ;
        $notify->saveOrFail();
