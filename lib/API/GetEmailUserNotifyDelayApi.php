...
class GetEmailUserNotifyDelayApi extends ApiValidatorAbstract implements ApiInterface
{
    use ResponseTraits;
    ...
    function run(): void
    {
        ...
        if (empty($notify) || empty($delay =$notify->delay)) {
            $delay = 0;
        }
        $this->responseData('success', ['delay' => $delay]);
    }
